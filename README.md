Transcription of Hilda Petrie's Diaries
==========================================
...
of Hilda Petrie's diaries.

This application has basic files:
...
* results.html: empty for this project 
...
You need to use the PBS command line interface for creating and updating the project. You can either run this from
your local environment or from your home directory on the server running the software.
...
As we use flickr for hosting the images, you should just be able to use the built in flickr importer. 
All you need to do is get the set number and enter this into the importer.
